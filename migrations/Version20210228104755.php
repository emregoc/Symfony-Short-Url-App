 ...
 */
final class Version20210228104755 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE url_stats ADD created_at DATETIME NOT NULL, CHANGE browser browser VARCHAR(120) NOT NULL, CHANGE device device VARCHAR(45) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE url_stats DROP created_at, CHANGE browser browser VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE device device VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
