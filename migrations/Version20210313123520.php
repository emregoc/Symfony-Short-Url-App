 ...
 */
final class Version20210313123520 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE url_stats ADD created_at DATETIME NOT NULL, CHANGE ip_address ip_address VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE url_stats DROP created_at, CHANGE ip_address ip_address INT NOT NULL');
